...
const Card = ({ title, pastor, content, date, image }: Preach) => {
  return (
    <div className='w-60 lg:w-80 hover:bg-[#e1e1e1] rounded-t-xl rounded-b-xl hover:shadow-xl hover:cursor-pointer transition-all duration-200'>
      <img
      className=' w-60 lg:w-80 rounded-t-xl h-36 lg:h-44 object-cover'
      src={image}
      alt={title} />
