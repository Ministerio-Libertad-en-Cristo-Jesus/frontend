import Orlando from '../assets/componentSVG/orlando'
import Paricua from '../assets/componentSVG/paricua'
import { type MapSlideInfoType, type MapSelectInfoType } from '../types/types'
